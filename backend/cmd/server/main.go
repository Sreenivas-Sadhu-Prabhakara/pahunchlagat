// Command server runs the pahunchlagat HTTP middleware.
package main
...
import (
	...
	"github.com/Sreenivas-Sadhu-Prabhakara/pahunchlagat/backend"
)
...
func main() {
	...
	log.Printf("pahunchlagat listening on %s", addr)
